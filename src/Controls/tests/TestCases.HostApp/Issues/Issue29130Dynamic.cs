...
[Issue(IssueTracker.Github, 0, "CollectionView ItemSizingStrategy.MeasureFirstItem should work when items are added dynamically to empty collection", PlatformAffected.All)]
