...
namespace Microsoft.Maui.Controls.Core.UnitTests
{
	...
	public class FlyoutPageUnitTests : BaseTestFixture
	{
		...
		public void FlyoutPageDetailNavigation_EventsWithNavigationPage()
		{
			...
			var firstDetailContent = new LCPage { Title = "First Detail Content" };
			var firstDetail = new LCNavigationPage(firstDetailContent) { Title = "First Detail Nav" };
			var secondDetailContent = new LCPage { Title = "Second Detail Content" };
			var secondDetail = new LCNavigationPage(secondDetailContent) { Title = "Second Detail Nav" };
			var flyoutPage = new FlyoutPage
			{
				Flyout = new ContentPage { Title = "Flyout" },
				Detail = firstDetail
		...
		public void FlyoutPageFlyoutNavigation_EventsWithContentPage()
		{
			...
			var firstFlyout = new LCPage { Title = "First Flyout" };
			var secondFlyout = new LCPage { Title = "Second Flyout" };
			var flyoutPage = new FlyoutPage
			{
				Flyout = firstFlyout,
				Detail = new ContentPage { Title = "Detail" }
		...
		public void FlyoutPageFlyoutNavigation_EventsWithNavigationPage()
		{
			...
			var firstFlyoutContent = new LCPage { Title = "First Flyout Content" };
			var firstFlyout = new LCNavigationPage(firstFlyoutContent) { Title = "First Flyout Nav" };
			var secondFlyoutContent = new LCPage { Title = "Second Flyout Content" };
			var secondFlyout = new LCNavigationPage(secondFlyoutContent) { Title = "Second Flyout Nav" };
			var flyoutPage = new FlyoutPage
			{
				Flyout = firstFlyout,
				Detail = new ContentPage { Title = "Detail" }
		...
		public class LCNavigationPage : NavigationPage
		{
			public NavigatedFromEventArgs NavigatedFromArgs { get; private set; }
			public NavigatingFromEventArgs NavigatingFromArgs { get; private set; }
			public NavigatedToEventArgs NavigatedToArgs { get; private set; }

			public LCNavigationPage(Page root) : base(root) { }
